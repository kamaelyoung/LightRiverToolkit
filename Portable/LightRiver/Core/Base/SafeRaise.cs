...
namespace LightRiver
{
    public static class SafeRaise
    {
        ...
        public static void RaiseEventAsync(EventHandler eventToRaise, object sender)
        {
            if (eventToRaise != null) {
                eventToRaise.BeginInvoke(sender, EventArgs.Empty, null, null);
            }
        }
        ...
        public static void RaiseAsync<T>(EventHandler<T> eventToRaise, object sender, T args) where T : EventArgs
        {
            if (eventToRaise != null) {
                eventToRaise.BeginInvoke(sender, args, null, null);
            }
        }
